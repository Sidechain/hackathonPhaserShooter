class Entity extends Phaser.GameObjects.Sprite {
    ...
    explode(canDestroy) {
        ...
        if (!this.getData("isDead")) {
            ...
            this.scene.sfx.explosions[Phaser.Math.Between(0, this.scene.sfx.explosions.length - 1)].play(); //  Randomize explosion sound
...
class Player extends Entity {
    ...
    onWin() {
        this.scene.scene.start("SceneHero");
    }
...
class ChaserShip extends Entity {
    constructor(scene, x, y) {
        ...
        this.body.velocity.y = Phaser.Math.Between(250, 350);
        this.states = {
            MOVE_DOWN: "MOVE_DOWN",
            CHASE: "CHASE"
        };
...
class GunShip extends Entity {
    constructor(scene, x, y) {
        ...
        this.shootTimer = this.scene.time.addEvent({
            delay: 1000, //change value to make ship shoot more/less
            callback: function() {
